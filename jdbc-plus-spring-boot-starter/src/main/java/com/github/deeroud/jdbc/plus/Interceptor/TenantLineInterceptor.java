...
import com.github.deeroud.jdbc.plus.handler.TenantLineHandler;
import com.github.deeroud.jdbc.plus.method.MethodInfo;
import com.github.deeroud.jdbc.plus.util.CollectionUtils;
...
public class TenantLineInterceptor extends BaseMultiTableInterceptor implements IInterceptor {
    ...
    public void beforePrepare(final Object[] args, MethodInfo methodInfo, JdbcTemplate jdbcTemplate) {
        args[0] = this.parserMulti(args[0].toString(), null);
    }
